            ...
            react_1.default.createElement("table", { className: "container" },
                react_1.default.createElement("thead", null,
                    react_1.default.createElement("tr", null,
                        ...
                        react_1.default.createElement("th", null))),
                react_1.default.createElement("tbody", null, this.props.sellers.map((organizer) => (react_1.default.createElement("tr", null,
                    react_1.default.createElement("th", null, organizer.businessName),
                    ...
                    react_1.default.createElement("th", null,
                        react_1.default.createElement("button", { "data-action": "delete", "data-id": organizer.id, "data-status": organizer.status, className: organizer.status !== types_1.EntityStatus.Rejected ? "delete" : "disabled" }, "Delete")),
                    react_1.default.createElement("th", null,
                        react_1.default.createElement("button", { "data-action": "validate", "data-id": organizer.id, "data-status": organizer.status, className: organizer.status !== types_1.EntityStatus.Accepted ? "validate" : "disabled" }, "Validate"))))))),
