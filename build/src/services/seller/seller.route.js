...
class SellerRoutes {
    ...
    _assignRoute() {
        ...
        this._router.route('/login').patch(acl_1.authorizeForSeller, (0, helpers_1.checkParametersAndCallRoute)(seller_controller_1.SellerController.validateSellerEmail));
