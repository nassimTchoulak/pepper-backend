...
class AdminController {
    static updateStatus(req, res) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            yield orms_1.Seller.update({ status: req.body.status }, { where: { id: req.body.id } });
            const organizer = yield orms_1.Seller.findOne({ where: { id: req.body.id }, raw: true });
...
(0, tslib_1.__decorate)([
    (0, helpers_1.validation)(joi_1.default.object({
        ...
        status: joi_1.default.string().valid(types_1.UserStatus.Pending, types_1.UserStatus.Accepted, types_1.UserStatus.Rejected).required(),
    }))
